...
namespace ElogicCo\ImportMagento\Console;
...
use ElogicCo\ImportMagento\Api\Extensions\RememberProcessor\RememberProcessorPoolInterface;
...
class DefaultImport extends Command
{
    ...
    public function getDataForImport(InputInterface $input, OutputInterface $output): array
    {
        ...
        $dataForImport = [];
        try {
            /** @var \ElogicCo\ImportMagento\Api\DataProvider\TableDataProviderInterface $dataProvider */
    ...
    public function importData(array $dataForImport, InputInterface $input, OutputInterface $output): int
    {
        ...
        /** \ElogicCo\ImportMagento\Api\Data\DataImportInfoInterface $dataImportInfo */
     ...
     * @see \ElogicCo\ImportMagento\Console\DefaultImport::interact()
     *
     * @param InputInterface $input
     * @param OutputInterface $output
